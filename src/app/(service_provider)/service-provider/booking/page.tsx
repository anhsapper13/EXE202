...
const Booking: React.FC = () => {
  ...
  // const [availableVeterinarians, setAvailableVeterinarians] = useState<any[]>(
  //   []
  // );
  ...
  //   const booking = bookings.find((app) => app.booking_id === id);
  //   if (booking) {
  //     setSelectedBooking(booking);
  //     setSelectedDate(new Date(booking.bookingTime));
  ...
  //   // // Restore the function to fetch available veterinarians
  //   // if (newDate && selectedbooking) {
  //   //   fetchAvailableVeterinarians(selectedbooking.service_id._id, newDate);
  //   // }
  // };
  ...
  //     try {
  //       // Ensure we're sending the date in UTC format
  //       const isoDateString = selectedDate.toISOString();

  //       await bookingService.confirmMeetingDate(
  //         selectedbooking._id,
  //         isoDateString
  //       );
  ...
  //       message.success("Meeting date updated successfully");
  //     } catch (error) {
  //       console.error("Error updating meeting date:", error);
  //       message.error("Failed to update meeting date");
  //     }
  //   } else {
  ...
  // Helper function to safely display object properties
  // const safeDisplayValue = (value: any, propertyName?: string): string => {
  //   if (value === null || value === undefined) {
  //     return "Not available";
  //   }

  //   if (typeof value === "object") {
  //     // If a specific property is requested and exists, return it
  //     if (propertyName && value[propertyName] !== undefined) {
  //       return String(value[propertyName]);
  //     }
  //     // Otherwise return the object's ID if available
  //     if (value._id) {
  //       return String(value._id);
  //     }
  //     // Last resort
  //     return "Object (details not available)";
  //   }
          ...
          <div className="space-y-6">
            ...
            >
              <Descriptions.Item label="ID">
                {detailBooking.user?.firstName +
                  " " +
                  detailBooking.user?.lastName || "Nguyen Truong Anh"}
              </Descriptions.Item>
              <Descriptions.Item label="ID">
            ...
            <>
              <Card className="bg-gray-50">
                <div className="mb-4">
                  ...
                  <p>
                    {detailBooking.description || "No description provided"}
                  </p>
                </div>
